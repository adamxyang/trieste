...
from trieste.acquisition.function.non_myopic import BatchMonteCarloExpectedImprovement_penalty, Glasses, EfficientGlobalOptimization_qEI
from trieste.acquisition import (
    SingleModelAcquisitionBuilder,
    ExpectedImprovement,
    Product,
...
if acquisition == 'EI':
    ...
    monte_carlo_sample_size = 100
    batch_ei_acq = BatchMonteCarloExpectedImprovement_penalty(
        sample_size=monte_carlo_sample_size, jitter=1e-5, cost_per_step=cost_per_step, cost_L1=cost_L1
    )
    batch_size = 1
    ...
    acquisition += f' penalty {batch_size}'
